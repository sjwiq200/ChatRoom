$(function() {
  ...
  socket.on('new msg', function(data) {
     ...
     * 서버에서 받은 img처리
     */
  socket.on('new imgMsg', function(data){

      var img = new Image();
      img.src = 'data:image/jpeg;base64,'+data.msg.buffer;
   ...
   *  이미지 기능
   *  */
  $(".chat-input-append input[type='submit']").click(function(){
    ...
    var formData = new FormData($('#userfile'));
